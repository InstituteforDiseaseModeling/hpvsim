...
def get_genotype_pars(default=False, genotype=None):
    ...
    pars = dict(
        ...
        hpv16 = dict(
            rel_beta        = 1.0, # Transmission was relatively homogeneous across HPV genotypes, alpha species, and oncogenic risk categories -- doi: 10.2196/11284
            rel_cin1_prob    = 5.0,
            rel_cin2_prob=5.0,
            rel_cin3_prob=5.0,
            rel_cancer_prob = 5.0,
        ...
        hpv11=dict(
            rel_beta=1.0,  # doi: 10.2196/11284
            rel_cin1_prob=0,
            rel_cin2_prob=0,
            rel_cin3_prob=0,
            rel_cancer_prob=0,
