...
# Set environment
os.environ['SPHINX_BUILD'] = 'True' # This is used so hpv.options.set('jupyter') doesn't reset the Matplotlib renderer
...
html_theme_options = {
    ...
    "show_prev_next": True,
    "icon_links": [
        {"name": "Web", "url": "https://hpvsim.org", "icon": "fas fa-home"},
        {
            "name": "GitHub",
            "url": "https://github.com/institutefordiseasemodeling/hpvsim",
