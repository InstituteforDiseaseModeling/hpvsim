...
def test_epi():
    ...
    base_pars = dict(n_agents=5e3, n_years=10, dt=0.5, network='random', beta=0.05, eff_condoms=0.6)
    sim = hpv.Sim(pars=base_pars)
    sim.initialize()

    # Define the parameters to vary
    vary_pars   = ['model_hiv',     'beta',          'acts',             'condoms',          'debut',            'init_hpv_prev', ] # Parameters
    vary_vals   = [[False, True],   [0.0001, 0.99],    [1, 200],           [0.01,0.6],         [15,25],             [0.01,0.8]] # Values
